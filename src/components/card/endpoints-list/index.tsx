...
const EndpointListCard: React.FC<EndpointListCardProps> = ({
  id,
  endpoint,
  mockDetails,
  moxyType,
    ...
    <>
      <div className={S.cardMoxyDetails}>
        <div className={S.cardLeftDetails}>
          <div title={endpoint} className={S.cardUrl}>
            {endpoint}
          </div>
        </div>
        ...
        <div className={S.cardRightDetails}>
          <div className={S.cardTargetDetails}>
            {moxyType === 'mock' && (
              <>
                <Image
                  className={S.cardTargetIcon}
                  src='/icons/collection.svg'
                  alt=''
                  width='26'
                  height='26'
                />
                <div title={mockDetails?.collectionId} className={S.cardUrl}>
                  {mockDetails?.collectionId}
                </div>
              </>
            )}
            {moxyType === 'proxy' && (
              <>
                <Image
                  ...
                  height='26'
                />
                <div title={proxyDetails.targetHost} className={S.cardUrl}>
                  {proxyDetails.targetHost}
                </div>
              </>
            )}
          </div>

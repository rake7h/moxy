...
const Page = async () => {
    ...
    return (
        <>
            <OutletHeader title='Records' subtitle="Records are raw data that can be JSON, HTML, JS etc. Records can be mapped to an endpoint for mocking." actionChildren={<HeaderActions />} />
            <OutletBody>
                {data.map((ep: any) => (
